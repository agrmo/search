...
public class Graph {
    ...
    // Die Liste von Paaren, die die Knoten einer Kante zeigen. Die
    // Knoten sind genau die Kennzeichen der Listen.
    // z.B. [[1,2],[0,1],[2,0]] ist eine Schleife.
    // 
    // Nehmen wir an, daß jede Kante is nur einmal in Paare gegeben,
    // z.B. nur [1,2] und nicht beide [1,2] und [2,1].
    // 
    // Lassen wir auch prüfen, daß eine Kante nur einmal in der
    // Struktur addiert wird. d.i.
    //
    // if (Kante noch nicht im n ist) {
    //   füge die Kante in n ein
    // }
    // 
    // Baue einen neuen Graph mit keinem Knoten und keiner Kante.
    public Graph() {
	this.groesse = 0;
